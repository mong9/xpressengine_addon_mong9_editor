...
## 실치방법
1. 다운받은 xpressengine_addon_mong9_editor.zip의 압축을 풀면, xpressengine_addon_mong9_editor 라는 폴더명을 "mong9_editor" 라는 폴더명으로 변경한다.
2. ~/addons/ 폴더에 mong9_editor 폴더를 업로드한다.
3. 관리자모드 > 고급 > 설치된 애드온 > Mong9 Editor 애드온 의 PC, Mobile 체크 후 저장합니다.

## 데모(DEMO)페이지
[https://www.mong9editor.com/index.cgi?page_code=otherpage&code=cms_xpressengine](https://www.mong9editor.com/index.cgi?page_code=otherpage&code=cms_xpressengine)# xpressengine_addon_mong9_editor
